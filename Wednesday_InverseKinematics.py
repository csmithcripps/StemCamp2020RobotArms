'''
This is the code the students will build day 2 in the morning
Students will be building this file in groups of 2 or 3
'''
...
def convertXYZtoRTheta(x,y,z,attack,claw):
    


# 2d list that holds the sequence
# Replace this with the sequence required to move the blocks to there other locations
